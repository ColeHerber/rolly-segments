...
% To target a different natural frequency, adjust m_hook or beam geometry.
...
d_stroke_1cell = 8.25e-3; % [m]  Single-beam stroke
...
% Singular-beam stroke and saddle
...
%   Calibrated so that peak of applied external force = F_push_1cell for this
%   singular-beam copy.
...
fprintf('  Mechanism stroke   = %.1f mm  (%d singular beam, %.1f mm each)\n', ...
